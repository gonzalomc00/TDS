...
public abstract class FactoriaDAO {
	...
	// Métodos que deberán implementar las factorias que sean creadas. Cada objeto
	// devuelvo debe implementar una interfaz distinta, interfaz usada por todos los
	// adaptadores de la misma clase
