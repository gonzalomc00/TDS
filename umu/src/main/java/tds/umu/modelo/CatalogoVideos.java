...
public class CatalogoVideos {
	...
	/*
	 * Esta clase mantiene en memoria todos los videos almacenados. De esta forma no
	 * hace falta entrar todo el rato a la base de datos a obtener los objetos.
	 */
	...
	public List<Video> getMasVistos() {
		/*
		 * Usamos un stream para ir comparando el número de reproducciones de todos los
		 * videos del catálogo.
		 */
		List<Video> resultado = videos.values().stream()
				.sorted(Comparator.comparingInt(Video::getNumReproducciones).reversed()).limit(Constantes.TOP)
	...
	/*
	 * Método para recuperar una lista de vídeos que corresponden a una búsqueda en
	 * específico. Para realizar la búsqueda se utiliza una cadena de texto que
	 * filtra el título del vídeo, una lista de etiquetas que deben contener(en su
	 * totalidad o parcial) los vídeos encontrados y, además, se le aplica el filtro
	 * que tenga actualmente seleccionado el usuario.
	 */
